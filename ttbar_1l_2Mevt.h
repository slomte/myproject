...
// Thu May 23 15:58:56 2019 by ROOT version 5.34/36
// from TTree Delphes/Analysis tree
// found on file: ttbar_1l_2Mevt.root
//////////////////////////////////////////////////////////

#ifndef ttbar_1l_2Mevt_h
#define ttbar_1l_2Mevt_h
...
public :
   ...
   ttbar_1l_2Mevt(TTree *tree=0);
   virtual ~ttbar_1l_2Mevt();
...
#ifdef ttbar_1l_2Mevt_cxx
ttbar_1l_2Mevt::ttbar_1l_2Mevt(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ttbar_1l_2Mevt.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ttbar_1l_2Mevt.root");
      }
...
ttbar_1l_2Mevt::~ttbar_1l_2Mevt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ttbar_1l_2Mevt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttbar_1l_2Mevt::LoadTree(Long64_t entry)
{
...
void ttbar_1l_2Mevt::Init(TTree *tree)
{
...
void ttbar_1l_2Mevt::Show(Long64_t entry)
{
...
Int_t ttbar_1l_2Mevt::Cut(Long64_t entry)
{
...
#endif // #ifdef ttbar_1l_2Mevt_cxx
