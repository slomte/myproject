#define ttbarZ_1lept_nunu_cxx
#include "ttbarZ_1lept_nunu.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void ttbarZ_1lept_nunu::Loop()
{
//   In a ROOT session, you can do:
//      root> .L ttbarZ_1lept_nunu.C
//      root> ttbarZ_1lept_nunu t
...
float weight = (0.08712*150*1000)/(50000);
...
//-------------------------------------------
Int_t ttbarZ_1lept_nunu::Output()
{
  TFile *rootfile = new TFile("Hst_ttbarZ_1lept_nunu.root", "RECREATE");
