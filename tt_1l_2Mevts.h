...
// Thu Aug  8 11:45:49 2019 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: tt_1l_2Mevts.root
//////////////////////////////////////////////////////////

#ifndef tt_1l_2Mevts_h
#define tt_1l_2Mevts_h
...
public :
   ...
   tt_1l_2Mevts(TTree *tree=0);
   virtual ~tt_1l_2Mevts();
...
#ifdef tt_1l_2Mevts_cxx
tt_1l_2Mevts::tt_1l_2Mevts(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tt_1l_2Mevts.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tt_1l_2Mevts.root");
      }
...
tt_1l_2Mevts::~tt_1l_2Mevts()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tt_1l_2Mevts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tt_1l_2Mevts::LoadTree(Long64_t entry)
{
...
void tt_1l_2Mevts::Init(TTree *tree)
{
...
void tt_1l_2Mevts::Show(Long64_t entry)
{
...
Int_t tt_1l_2Mevts::Cut(Long64_t entry)
{
