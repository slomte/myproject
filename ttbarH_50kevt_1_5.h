...
// Wed Jul 24 11:30:41 2019 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: ttbarH_50kevt_1_5.root
//////////////////////////////////////////////////////////

#ifndef ttbarH_50kevt_1_5_h
#define ttbarH_50kevt_1_5_h
...
public :
   ...
   ttbarH_50kevt_1_5(TTree *tree=0);
   virtual ~ttbarH_50kevt_1_5();
...
#ifdef ttbarH_50kevt_1_5_cxx
ttbarH_50kevt_1_5::ttbarH_50kevt_1_5(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ttbarH_50kevt_1_5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ttbarH_50kevt_1_5.root");
      }
...
ttbarH_50kevt_1_5::~ttbarH_50kevt_1_5()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ttbarH_50kevt_1_5::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttbarH_50kevt_1_5::LoadTree(Long64_t entry)
{
...
void ttbarH_50kevt_1_5::Init(TTree *tree)
{
...
Bool_t ttbarH_50kevt_1_5::Notify()
{
...
void ttbarH_50kevt_1_5::Show(Long64_t entry)
{
...
Int_t ttbarH_50kevt_1_5::Cut(Long64_t entry)
{
...
#endif // #ifdef ttbarH_50kevt_1_5_cxx
