...
// Fri Jul  5 14:57:48 2019 by ROOT version 6.08/06
// from TTree Delphes/Analysis tree
// found on file: stop_topN2_HZ_600300.root
//////////////////////////////////////////////////////////

#ifndef stop_topN2_HZ_600300_h
#define stop_topN2_HZ_600300_h
...
public :
   ...
   stop_topN2_HZ_600300(TTree *tree=0);
   virtual ~stop_topN2_HZ_600300();
...
#ifdef stop_topN2_HZ_600300_cxx
stop_topN2_HZ_600300::stop_topN2_HZ_600300(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stop_topN2_HZ_600300.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("stop_topN2_HZ_600300.root");
      }
...
stop_topN2_HZ_600300::~stop_topN2_HZ_600300()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stop_topN2_HZ_600300::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stop_topN2_HZ_600300::LoadTree(Long64_t entry)
{
...
void stop_topN2_HZ_600300::Init(TTree *tree)
{
...
Bool_t stop_topN2_HZ_600300::Notify()
{
...
void stop_topN2_HZ_600300::Show(Long64_t entry)
{
...
Int_t stop_topN2_HZ_600300::Cut(Long64_t entry)
{
...
#endif // #ifdef stop_topN2_HZ_600300_cxx
