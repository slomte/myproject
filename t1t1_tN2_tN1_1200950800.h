...
// Fri Aug 16 08:48:26 2019 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: t1t1_tN2_tN1_1200950800.root
//////////////////////////////////////////////////////////

#ifndef t1t1_tN2_tN1_1200950800_h
#define t1t1_tN2_tN1_1200950800_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4093;
   static constexpr Int_t kMaxGenJet = 19;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 19;
   static constexpr Int_t kMaxAK4_Jet = 19;
...
public :
   ...
   t1t1_tN2_tN1_1200950800(TTree *tree=0);
   virtual ~t1t1_tN2_tN1_1200950800();
...
//*********
   ...
   vector <Part> reco_fatjetsmatch;
   vector <Part> reco_resbbjets;

   vector <float> diffMass;
};

#endif

#ifdef t1t1_tN2_tN1_1200950800_cxx
t1t1_tN2_tN1_1200950800::t1t1_tN2_tN1_1200950800(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("t1t1_tN2_tN1_1200950800.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("t1t1_tN2_tN1_1200950800.root");
      }
...
t1t1_tN2_tN1_1200950800::~t1t1_tN2_tN1_1200950800()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t t1t1_tN2_tN1_1200950800::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t t1t1_tN2_tN1_1200950800::LoadTree(Long64_t entry)
{
...
void t1t1_tN2_tN1_1200950800::Init(TTree *tree)
{
...
Bool_t t1t1_tN2_tN1_1200950800::Notify()
{
...
void t1t1_tN2_tN1_1200950800::Show(Long64_t entry)
{
...
Int_t t1t1_tN2_tN1_1200950800::Cut(Long64_t entry)
{
...
#endif // #ifdef t1t1_tN2_tN1_1200950800_cxx
