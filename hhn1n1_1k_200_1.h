...
// Fri May 17 08:37:04 2019 by ROOT version 6.08/06
// from TTree Delphes/Analysis tree
// found on file: HHN1N1_1TeV_200GeV_1GeV.root
//////////////////////////////////////////////////////////

#ifndef hhn1n1_1k_200_1_h
#define hhn1n1_1k_200_1_h
...
public :
   ...
   UInt_t          AK4_Jet_Area_fUniqueID[kMaxAK4_Jet];   //[AK4_Jet_]
   UInt_t          AK4_Jet_Area_fBits[kMaxAK4_Jet];   //[AK4_Jet_]
   UInt_t          AK4_Jet_Area_fP_fUniqueID[kMaxAK4_Jet];   //[AK4_Jet_]
   UInt_t          AK4_Jet_Area_fP_fBits[kMaxAK4_Jet];   //[AK4_Jet_]
   Double_t        AK4_Jet_Area_fP_fX[kMaxAK4_Jet];   //[AK4_Jet_]
   Double_t        AK4_Jet_Area_fP_fY[kMaxAK4_Jet];   //[AK4_Jet_]
   Double_t        AK4_Jet_Area_fP_fZ[kMaxAK4_Jet];   //[AK4_Jet_]
   Double_t        AK4_Jet_Area_fE[kMaxAK4_Jet];   //[AK4_Jet_]
   Int_t           AK4_Jet_size;
   Int_t           AK8_Jet_;
   ...
   UInt_t          AK8_Jet_Area_fUniqueID[kMaxAK8_Jet];   //[AK8_Jet_]
   UInt_t          AK8_Jet_Area_fBits[kMaxAK8_Jet];   //[AK8_Jet_]
   UInt_t          AK8_Jet_Area_fP_fUniqueID[kMaxAK8_Jet];   //[AK8_Jet_]
   UInt_t          AK8_Jet_Area_fP_fBits[kMaxAK8_Jet];   //[AK8_Jet_]
   Double_t        AK8_Jet_Area_fP_fX[kMaxAK8_Jet];   //[AK8_Jet_]
   Double_t        AK8_Jet_Area_fP_fY[kMaxAK8_Jet];   //[AK8_Jet_]
   Double_t        AK8_Jet_Area_fP_fZ[kMaxAK8_Jet];   //[AK8_Jet_]
   Double_t        AK8_Jet_Area_fE[kMaxAK8_Jet];   //[AK8_Jet_]
   Int_t           AK8_Jet_size;
   Int_t           AK12_Jet_;
   ...
   UInt_t          AK12_Jet_Area_fUniqueID[kMaxAK12_Jet];   //[AK12_Jet_]
   UInt_t          AK12_Jet_Area_fBits[kMaxAK12_Jet];   //[AK12_Jet_]
   UInt_t          AK12_Jet_Area_fP_fUniqueID[kMaxAK12_Jet];   //[AK12_Jet_]
   UInt_t          AK12_Jet_Area_fP_fBits[kMaxAK12_Jet];   //[AK12_Jet_]
   Double_t        AK12_Jet_Area_fP_fX[kMaxAK12_Jet];   //[AK12_Jet_]
   Double_t        AK12_Jet_Area_fP_fY[kMaxAK12_Jet];   //[AK12_Jet_]
   Double_t        AK12_Jet_Area_fP_fZ[kMaxAK12_Jet];   //[AK12_Jet_]
   Double_t        AK12_Jet_Area_fE[kMaxAK12_Jet];   //[AK12_Jet_]
   Int_t           AK12_Jet_size;
   Int_t           Electron_;
   ...
   UInt_t          FatJet_Area_fUniqueID[kMaxFatJet];   //[FatJet_]
   UInt_t          FatJet_Area_fBits[kMaxFatJet];   //[FatJet_]
   UInt_t          FatJet_Area_fP_fUniqueID[kMaxFatJet];   //[FatJet_]
   UInt_t          FatJet_Area_fP_fBits[kMaxFatJet];   //[FatJet_]
   Double_t        FatJet_Area_fP_fX[kMaxFatJet];   //[FatJet_]
   Double_t        FatJet_Area_fP_fY[kMaxFatJet];   //[FatJet_]
   Double_t        FatJet_Area_fP_fZ[kMaxFatJet];   //[FatJet_]
   Double_t        FatJet_Area_fE[kMaxFatJet];   //[FatJet_]
   Int_t           FatJet_size;
   Int_t           MissingET_;
   ...
   TBranch        *b_AK4_Jet_Area_fUniqueID;   //!
   TBranch        *b_AK4_Jet_Area_fBits;   //!
   TBranch        *b_AK4_Jet_Area_fP_fUniqueID;   //!
   TBranch        *b_AK4_Jet_Area_fP_fBits;   //!
   TBranch        *b_AK4_Jet_Area_fP_fX;   //!
   TBranch        *b_AK4_Jet_Area_fP_fY;   //!
   TBranch        *b_AK4_Jet_Area_fP_fZ;   //!
   TBranch        *b_AK4_Jet_Area_fE;   //!
   ...
   TBranch        *b_AK8_Jet_Area_fUniqueID;   //!
   TBranch        *b_AK8_Jet_Area_fBits;   //!
   TBranch        *b_AK8_Jet_Area_fP_fUniqueID;   //!
   TBranch        *b_AK8_Jet_Area_fP_fBits;   //!
   TBranch        *b_AK8_Jet_Area_fP_fX;   //!
   TBranch        *b_AK8_Jet_Area_fP_fY;   //!
   TBranch        *b_AK8_Jet_Area_fP_fZ;   //!
   TBranch        *b_AK8_Jet_Area_fE;   //!
   ...
   TBranch        *b_AK12_Jet_Area_fUniqueID;   //!
   TBranch        *b_AK12_Jet_Area_fBits;   //!
   TBranch        *b_AK12_Jet_Area_fP_fUniqueID;   //!
   TBranch        *b_AK12_Jet_Area_fP_fBits;   //!
   TBranch        *b_AK12_Jet_Area_fP_fX;   //!
   TBranch        *b_AK12_Jet_Area_fP_fY;   //!
   TBranch        *b_AK12_Jet_Area_fP_fZ;   //!
   TBranch        *b_AK12_Jet_Area_fE;   //!
   ...
   TBranch        *b_FatJet_Area_fUniqueID;   //!
   TBranch        *b_FatJet_Area_fBits;   //!
   TBranch        *b_FatJet_Area_fP_fUniqueID;   //!
   TBranch        *b_FatJet_Area_fP_fBits;   //!
   TBranch        *b_FatJet_Area_fP_fX;   //!
   TBranch        *b_FatJet_Area_fP_fY;   //!
   TBranch        *b_FatJet_Area_fP_fZ;   //!
   TBranch        *b_FatJet_Area_fE;   //!
   ...
   hhn1n1_1k_200_1(TTree *tree=0);
   virtual ~hhn1n1_1k_200_1();
...
//*********
   ...
   //std::vector <TLorentzVector> sum1;
};

#endif

#ifdef hhn1n1_1k_200_1_cxx
hhn1n1_1k_200_1::hhn1n1_1k_200_1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("HHN1N1_1TeV_200GeV_1GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("HHN1N1_1TeV_200GeV_1GeV.root");
      }
...
hhn1n1_1k_200_1::~hhn1n1_1k_200_1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hhn1n1_1k_200_1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hhn1n1_1k_200_1::LoadTree(Long64_t entry)
{
...
void hhn1n1_1k_200_1::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("AK4_Jet.Area.fUniqueID", AK4_Jet_Area_fUniqueID, &b_AK4_Jet_Area_fUniqueID);
   fChain->SetBranchAddress("AK4_Jet.Area.fBits", AK4_Jet_Area_fBits, &b_AK4_Jet_Area_fBits);
   fChain->SetBranchAddress("AK4_Jet.Area.fP.fUniqueID", AK4_Jet_Area_fP_fUniqueID, &b_AK4_Jet_Area_fP_fUniqueID);
   fChain->SetBranchAddress("AK4_Jet.Area.fP.fBits", AK4_Jet_Area_fP_fBits, &b_AK4_Jet_Area_fP_fBits);
   fChain->SetBranchAddress("AK4_Jet.Area.fP.fX", AK4_Jet_Area_fP_fX, &b_AK4_Jet_Area_fP_fX);
   fChain->SetBranchAddress("AK4_Jet.Area.fP.fY", AK4_Jet_Area_fP_fY, &b_AK4_Jet_Area_fP_fY);
   fChain->SetBranchAddress("AK4_Jet.Area.fP.fZ", AK4_Jet_Area_fP_fZ, &b_AK4_Jet_Area_fP_fZ);
   fChain->SetBranchAddress("AK4_Jet.Area.fE", AK4_Jet_Area_fE, &b_AK4_Jet_Area_fE);
   ...
   fChain->SetBranchAddress("AK8_Jet.Area.fUniqueID", AK8_Jet_Area_fUniqueID, &b_AK8_Jet_Area_fUniqueID);
   fChain->SetBranchAddress("AK8_Jet.Area.fBits", AK8_Jet_Area_fBits, &b_AK8_Jet_Area_fBits);
   fChain->SetBranchAddress("AK8_Jet.Area.fP.fUniqueID", AK8_Jet_Area_fP_fUniqueID, &b_AK8_Jet_Area_fP_fUniqueID);
   fChain->SetBranchAddress("AK8_Jet.Area.fP.fBits", AK8_Jet_Area_fP_fBits, &b_AK8_Jet_Area_fP_fBits);
   fChain->SetBranchAddress("AK8_Jet.Area.fP.fX", AK8_Jet_Area_fP_fX, &b_AK8_Jet_Area_fP_fX);
   fChain->SetBranchAddress("AK8_Jet.Area.fP.fY", AK8_Jet_Area_fP_fY, &b_AK8_Jet_Area_fP_fY);
   fChain->SetBranchAddress("AK8_Jet.Area.fP.fZ", AK8_Jet_Area_fP_fZ, &b_AK8_Jet_Area_fP_fZ);
   fChain->SetBranchAddress("AK8_Jet.Area.fE", AK8_Jet_Area_fE, &b_AK8_Jet_Area_fE);
   ...
   fChain->SetBranchAddress("AK12_Jet.Area.fUniqueID", AK12_Jet_Area_fUniqueID, &b_AK12_Jet_Area_fUniqueID);
   fChain->SetBranchAddress("AK12_Jet.Area.fBits", AK12_Jet_Area_fBits, &b_AK12_Jet_Area_fBits);
   fChain->SetBranchAddress("AK12_Jet.Area.fP.fUniqueID", AK12_Jet_Area_fP_fUniqueID, &b_AK12_Jet_Area_fP_fUniqueID);
   fChain->SetBranchAddress("AK12_Jet.Area.fP.fBits", AK12_Jet_Area_fP_fBits, &b_AK12_Jet_Area_fP_fBits);
   fChain->SetBranchAddress("AK12_Jet.Area.fP.fX", AK12_Jet_Area_fP_fX, &b_AK12_Jet_Area_fP_fX);
   fChain->SetBranchAddress("AK12_Jet.Area.fP.fY", AK12_Jet_Area_fP_fY, &b_AK12_Jet_Area_fP_fY);
   fChain->SetBranchAddress("AK12_Jet.Area.fP.fZ", AK12_Jet_Area_fP_fZ, &b_AK12_Jet_Area_fP_fZ);
   fChain->SetBranchAddress("AK12_Jet.Area.fE", AK12_Jet_Area_fE, &b_AK12_Jet_Area_fE);
   ...
   fChain->SetBranchAddress("FatJet.Area.fUniqueID", FatJet_Area_fUniqueID, &b_FatJet_Area_fUniqueID);
   fChain->SetBranchAddress("FatJet.Area.fBits", FatJet_Area_fBits, &b_FatJet_Area_fBits);
   fChain->SetBranchAddress("FatJet.Area.fP.fUniqueID", FatJet_Area_fP_fUniqueID, &b_FatJet_Area_fP_fUniqueID);
   fChain->SetBranchAddress("FatJet.Area.fP.fBits", FatJet_Area_fP_fBits, &b_FatJet_Area_fP_fBits);
   fChain->SetBranchAddress("FatJet.Area.fP.fX", FatJet_Area_fP_fX, &b_FatJet_Area_fP_fX);
   fChain->SetBranchAddress("FatJet.Area.fP.fY", FatJet_Area_fP_fY, &b_FatJet_Area_fP_fY);
   fChain->SetBranchAddress("FatJet.Area.fP.fZ", FatJet_Area_fP_fZ, &b_FatJet_Area_fP_fZ);
   fChain->SetBranchAddress("FatJet.Area.fE", FatJet_Area_fE, &b_FatJet_Area_fE);
...
void hhn1n1_1k_200_1::Show(Long64_t entry)
{
...
Int_t hhn1n1_1k_200_1::Cut(Long64_t entry)
{
...
#endif // #ifdef hhn1n1_1k_200_1_cxx
