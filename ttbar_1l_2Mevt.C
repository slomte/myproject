#define ttbar_1l_2Mevt_cxx
#include "ttbar_1l_2Mevt.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void ttbar_1l_2Mevt::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L ttbar_1l_2Mevt.C
//      Root > ttbar_1l_2Mevt t
...
//-------------------------------------------
Int_t ttbar_1l_2Mevt::Output()
{
  TFile *rootfile = new TFile("Hst_ttbar_1l_2Mevt.root", "RECREATE");
