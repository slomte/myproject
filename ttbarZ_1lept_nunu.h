...
// Mon Jul 29 15:39:59 2019 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: ttbarZ_1lept_nunu.root
//////////////////////////////////////////////////////////

#ifndef ttbarZ_1lept_nunu_h
#define ttbarZ_1lept_nunu_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxAK4_Jet = 15;
   static constexpr Int_t kMaxAK8_Jet = 14;
   static constexpr Int_t kMaxAK12_Jet = 11;
...
public :
   ...
   ttbarZ_1lept_nunu(TTree *tree=0);
   virtual ~ttbarZ_1lept_nunu();
...
#ifdef ttbarZ_1lept_nunu_cxx
ttbarZ_1lept_nunu::ttbarZ_1lept_nunu(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ttbarZ_1lept_nunu.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ttbarZ_1lept_nunu.root");
      }
...
ttbarZ_1lept_nunu::~ttbarZ_1lept_nunu()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ttbarZ_1lept_nunu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttbarZ_1lept_nunu::LoadTree(Long64_t entry)
{
...
void ttbarZ_1lept_nunu::Init(TTree *tree)
{
...
Bool_t ttbarZ_1lept_nunu::Notify()
{
...
void ttbarZ_1lept_nunu::Show(Long64_t entry)
{
...
Int_t ttbarZ_1lept_nunu::Cut(Long64_t entry)
{
...
#endif // #ifdef ttbarZ_1lept_nunu_cxx
