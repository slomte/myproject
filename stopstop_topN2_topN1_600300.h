...
// Thu Jul 25 10:00:35 2019 by ROOT version 6.10/08
// from TTree Delphes/Analysis tree
// found on file: stopstop_topN2_topN1_600300.root
//////////////////////////////////////////////////////////

#ifndef stopstop_topN2_topN1_600300_h
#define stopstop_topN2_topN1_600300_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4336;
   static constexpr Int_t kMaxGenJet = 19;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 17;
   static constexpr Int_t kMaxAK4_Jet = 18;
   static constexpr Int_t kMaxAK8_Jet = 15;
   static constexpr Int_t kMaxAK12_Jet = 12;
...
class stopstop_topN2_topN1_600300 {
public :
   ...
   stopstop_topN2_topN1_600300(TTree *tree=0);
   virtual ~stopstop_topN2_topN1_600300();
...
//*********
   ...
   vector <Part> bquarks_H;
   vector <Part> bquarks_t;
   vector <Part> stops;
   vector <Part> tops;
   vector <Part> Higgs;
   vector <Part> Neu2s;
   vector <Part> Neu1s;
   vector <Part> Neu1ss;
   vector <Part> missinget;
   vector <Part> reco_leps;
   vector <Part> reco_jets;
   vector <Part> reco_bjets;
   vector <Part> reco_fatjets;
};

#endif

#ifdef stopstop_topN2_topN1_600300_cxx
stopstop_topN2_topN1_600300::stopstop_topN2_topN1_600300(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stopstop_topN2_topN1_600300.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("stopstop_topN2_topN1_600300.root");
      }
...
stopstop_topN2_topN1_600300::~stopstop_topN2_topN1_600300()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stopstop_topN2_topN1_600300::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stopstop_topN2_topN1_600300::LoadTree(Long64_t entry)
{
...
void stopstop_topN2_topN1_600300::Init(TTree *tree)
{
...
Bool_t stopstop_topN2_topN1_600300::Notify()
{
...
void stopstop_topN2_topN1_600300::Show(Long64_t entry)
{
...
Int_t stopstop_topN2_topN1_600300::Cut(Long64_t entry)
{
...
#endif // #ifdef stopstop_topN2_topN1_600300_cxx
