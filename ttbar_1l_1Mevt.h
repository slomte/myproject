...
// found on file: ttbar_1l_1Mevt.root
//////////////////////////////////////////////////////////

#ifndef ttbar_1l_1Mevt_h
#define ttbar_1l_1Mevt_h
...
public :
   ...
   ttbar_1l_1Mevt(TTree *tree=0);
   virtual ~ttbar_1l_1Mevt();
...
#ifdef ttbar_1l_1Mevt_cxx
ttbar_1l_1Mevt::ttbar_1l_1Mevt(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ttbar_1l_1Mevt.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ttbar_1l_1Mevt.root");
      }
...
ttbar_1l_1Mevt::~ttbar_1l_1Mevt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ttbar_1l_1Mevt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttbar_1l_1Mevt::LoadTree(Long64_t entry)
{
...
void ttbar_1l_1Mevt::Init(TTree *tree)
{
...
void ttbar_1l_1Mevt::Show(Long64_t entry)
{
...
Int_t ttbar_1l_1Mevt::Cut(Long64_t entry)
{
...
#endif // #ifdef ttbar_1l_1Mevt_cxx
