...
// Tue Jul  9 14:25:17 2019 by ROOT version 6.08/06
// from TTree Delphes/Analysis tree
// found on file: stopstop_topN2_topN1_750100.root
//////////////////////////////////////////////////////////

#ifndef stopstop_topN2_topN1_750100_h
#define stopstop_topN2_topN1_750100_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1454;
   const Int_t kMaxGenJet = 18;
   const Int_t kMaxGenMissingET = 1;
   const Int_t kMaxJet = 17;
   const Int_t kMaxAK4_Jet = 17;
   const Int_t kMaxAK8_Jet = 12;
...
class stopstop_topN2_topN1_750100 {
public :
   ...
   stopstop_topN2_topN1_750100(TTree *tree=0);
   virtual ~stopstop_topN2_topN1_750100();
...
#ifdef stopstop_topN2_topN1_750100_cxx
stopstop_topN2_topN1_750100::stopstop_topN2_topN1_750100(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stopstop_topN2_topN1_750100.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("stopstop_topN2_topN1_750100.root");
      }
...
stopstop_topN2_topN1_750100::~stopstop_topN2_topN1_750100()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stopstop_topN2_topN1_750100::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stopstop_topN2_topN1_750100::LoadTree(Long64_t entry)
{
...
void stopstop_topN2_topN1_750100::Init(TTree *tree)
{
...
Bool_t stopstop_topN2_topN1_750100::Notify()
{
...
void stopstop_topN2_topN1_750100::Show(Long64_t entry)
{
...
Int_t stopstop_topN2_topN1_750100::Cut(Long64_t entry)
{
...
#endif // #ifdef stopstop_topN2_topN1_750100_cxx
