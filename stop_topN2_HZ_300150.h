...
// Fri Jul  5 17:05:23 2019 by ROOT version 6.08/06
// from TTree Delphes/Analysis tree
// found on file: stop_topN2_HZ_300150.root
//////////////////////////////////////////////////////////

#ifndef stop_topN2_HZ_300150_h
#define stop_topN2_HZ_300150_h
...
public :
   ...
   stop_topN2_HZ_300150(TTree *tree=0);
   virtual ~stop_topN2_HZ_300150();
...
#ifdef stop_topN2_HZ_300150_cxx
stop_topN2_HZ_300150::stop_topN2_HZ_300150(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("stop_topN2_HZ_300150.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("stop_topN2_HZ_300150.root");
      }
...
stop_topN2_HZ_300150::~stop_topN2_HZ_300150()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stop_topN2_HZ_300150::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stop_topN2_HZ_300150::LoadTree(Long64_t entry)
{
...
void stop_topN2_HZ_300150::Init(TTree *tree)
{
...
Bool_t stop_topN2_HZ_300150::Notify()
{
...
void stop_topN2_HZ_300150::Show(Long64_t entry)
{
...
Int_t stop_topN2_HZ_300150::Cut(Long64_t entry)
{
...
#endif // #ifdef stop_topN2_HZ_300150_cxx
